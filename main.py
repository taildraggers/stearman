"""Scrape Stearman listings from Barnstormers.com and render them into
...
PAGE_TITLE = "Other Stearman Ads on the Web"
...
EXTERNAL_SEARCH_LINKS = [
    (
        "Trade-A-Plane",
        "https://www.trade-a-plane.com/filtered/search?s-type=aircraft&s-keyword-search=stearman&s-original-search=stearman",
    ),
    ("Controller", "https://www.controller.com/listings?keywords=stearman"),
    ("ASO", "https://aso.com/search?q=Stearman"),
]
...
<body>
  ...
  <div class="more-resources">
    <h2>Search More Stearman Listings</h2>
    <p>View additional Stearman Aircraft listings at these fine sites:</p>
